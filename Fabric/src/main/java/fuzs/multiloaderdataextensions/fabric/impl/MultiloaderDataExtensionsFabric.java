package fuzs.multiloaderdataextensions.fabric.impl;
...
public class MultiloaderDataExtensionsFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        DataResourceLoader.get()
                .registerReloadListener(MultiloaderDataExtensions.id(DataMapLoader.PATH),
